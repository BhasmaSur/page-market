        ...
        <div className="footer-max-width max-content-container">
          <div className="footer-banner">
            <h1 className="footer-text Heading2">
              ...
              <br></br>
              <span>MARKET1 conference</span>
            </h1>
            <span className="footer-text03">
              <span></span>
              <span>get ready for the most insightful marketing event</span>
            </span>
          ...
          <div className="footer-bottom-container">
            <div className="footer-left-side">
              ...
              <div className="footer-social-media">
                <span className="footer-text07">Follow market1</span>
      ...
      <style jsx>
        {`
          ...
          .footer-banner {
            ...
            background-image: url('/group%2029-1200w.png');
          }
          .footer-text {
